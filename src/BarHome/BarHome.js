...
function BarDashboardViewControl({ setDashboardState }) {
    return (
        <div className="view-control">
            <Button className="btn btn-secondary orders-btn"  onClick={() => { setDashboardState(0) }}>Orders</Button>
            <Button className="btn btn-secondary tabs-btn" onClick={() => { setDashboardState(1) }}>Tabs</Button>
        </div>
    )
}
...
function BarFooter() {
    return (
        <div className="liquorish-footer">
            <Button className="btn btn-primary transact-btn">Transactions</Button>
            <Button className="btn btn-secondary user-invite-btn">Invite User</Button>
        </div>
    )
}